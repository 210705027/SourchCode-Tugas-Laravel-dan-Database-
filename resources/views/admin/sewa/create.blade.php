@extends('layouts.app', ['title' => 'Tambah Sewa - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold  capitalize">TAMBAH SEWA</h2>
            <hr class="mt-4">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                            name="id" value="{{ old('id') }}" placeholder="Id Sewa">
                        @error('id')
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text"
                            name="nama_peminjam" value="{{ old('nama_peminjam') }}" placeholder="nama Peminjam">
                        @error('nama_peminjam')
                        <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                            <div class="px-4 py-2">
                                <p class="text-gray-600 text-sm">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="date"
                            name="tanggal_peminjaman" value="{{ old('tanggal_peminjaman') }}"
